...
function user_job_setup()
	...
	gear.obi_cure_back = { name="Alaunus's Cape", augments={'MND+20','MND+10','Enmity-10',}}

	gear.obi_nuke_waist = "Sekhmet Corset"
	gear.obi_high_nuke_waist = "Sekhmet Corset"
	gear.obi_nuke_back = gear.obi_cure_back --"Toro Cape"
...
function init_gear_sets()
	...
	-- Weapons sets
	sets.weapons.MeleeWeapons = {main="Daybreak",sub="Sors Shield"}
	sets.weapons.DualWeapons = {main="Daybreak",sub="Maxentius"}
    ...
    sets.precast.FC['Healing Magic'] = set_combine(sets.precast.FC, {main="Queller Rod",sub="Sors Shield",ear1="Mendi. Earring",legs="Ebers Pant. +1"})
    ...
    sets.MagicBurst = {sub="Enki Strap",neck="Mizu. Kubikazari",ring1="Mujin Band",ring2="Locus Ring"}
	...
	sets.midcast.Cure = {main="Queller Rod",sub="Sors Shield",--ammo="Pemphredo Tathlum",
		head="Kaykaus Mitra +1",neck="Clr. Torque +2",ear1="Mendi. Earring",ear2="Glorious Earring",
		body="Ebers Bliaut +1",hands="Weath. Cuffs +1",ring1="Stikini Ring +1",ring2="Menelaus's Ring",
		back={ name="Alaunus's Cape", augments={'MND+20','MND+10','Enmity-10',}},waist="Korin Obi",legs="Ebers Pant. +1",feet="Kaykaus Boots +1"}
		
	sets.midcast.CureSolace = sets.midcast.Cure --[[{main="Queller Rod",sub="Sors Shield",ammo="Pemphredo Tathlum",
	...
	sets.midcast.LightWeatherCure = sets.midcast.Cure --[[{main="Chatoyant Staff",sub="Curatio Grip",ammo="Esper Stone +1",
	...
	sets.midcast.LightWeatherCureSolace = sets.midcast.Cure --[[{main="Chatoyant Staff",sub="Curatio Grip",ammo="Esper Stone +1",
		head="Gende. Caubeen +1",neck="Incanter's Torque",ear1="Regal Earring",ear2="Glorious Earring",
		body="Ebers Bliaut +1",hands="Theophany Mitts +3",ring1="Janniston Ring",ring2="Lebeche Ring",
		back="Alaunus's Cape",waist="Korin Obi",legs="Ebers Pant. +1",feet="Kaykaus Boots"}--]]
		
	sets.midcast.LightDayCureSolace = sets.midcast.Cure --[[{main="Queller Rod",sub="Sors Shield",ammo="Pemphredo Tathlum",
		head="Gende. Caubeen +1",neck="Incanter's Torque",ear1="Regal Earring",ear2="Glorious Earring",
		body="Ebers Bliaut +1",hands="Theophany Mitts +3",ring1="Janniston Ring",ring2="Menelaus's Ring",
		back="Alaunus's Cape",waist="Korin Obi",legs="Ebers Pant. +1",feet="Kaykaus Boots"}--]]

	sets.midcast.LightDayCure = sets.midcast.Cure --[[{main="Queller Rod",sub="Sors Shield",ammo="Pemphredo Tathlum",
		head="Gende. Caubeen +1",neck="Incanter's Torque",ear1="Nourish. Earring +1",ear2="Glorious Earring",
		body="Theo. Bliaut +2",hands="Theophany Mitts +3",ring1="Janniston Ring",ring2="Menelaus's Ring",
		back="Twilight Cape",waist="Korin Obi",legs="Ebers Pant. +1",feet="Kaykaus Boots"}--]]

	sets.midcast.Curaga = sets.midcast.Cure --[[{main="Queller Rod",sub="Sors Shield",ammo="Pemphredo Tathlum",
		head="Gende. Caubeen +1",neck="Incanter's Torque",ear1="Regal Earring",ear2="Glorious Earring",
		body="Theo. Bliaut +2",hands="Theophany Mitts +3",ring1="Janniston Ring",ring2="Menelaus's Ring",
		back="Alaunus's Cape",waist="Luminary Sash",legs="Ebers Pant. +1",feet="Kaykaus Boots"}--]]
		
	sets.midcast.LightWeatherCuraga = sets.midcast.Cure --[[ {main="Chatoyant Staff",sub="Curatio Grip",ammo="Esper Stone +1",
		head="Gende. Caubeen +1",neck="Incanter's Torque",ear1="Nourish. Earring +1",ear2="Glorious Earring",
		body="Kaykaus Bliaut",hands="Theophany Mitts +3",ring1="Janniston Ring",ring2="Lebeche Ring",
		back="Twilight Cape",waist="Korin Obi",legs="Ebers Pant. +1",feet="Kaykaus Boots"}--]]
		
	sets.midcast.LightDayCuraga = sets.midcast.Cure --[[ {main="Queller Rod",sub="Sors Shield",ammo="Pemphredo Tathlum",
		head="Gende. Caubeen +1",neck="Incanter's Torque",ear1="Nourish. Earring +1",ear2="Glorious Earring",
		body="Theo. Bliaut +2",hands="Theophany Mitts +3",ring1="Janniston Ring",ring2="Menelaus's Ring",
		back="Twilight Cape",waist="Korin Obi",legs="Ebers Pant. +1",feet="Kaykaus Boots"}--]]

	sets.midcast.Cure.DT = sets.midcast.Cure --[[{main="Queller Rod",sub="Genmei Shield",ammo="Staunch Tathlum +1",
	...
	sets.midcast.MeleeCure = sets.midcast.Cure --[[{ammo="Pemphredo Tathlum",
		head="Gende. Caubeen +1",neck="Incanter's Torque",ear1="Regal Earring",ear2="Glorious Earring",
	...
	sets.midcast.Cursna = {main="Queller Rod",sub="Sors Shield",ammo="Ombre Tathlum +1",
		head="Ebers Cap +1",neck="Debilis Medallion",ear1="Meili Earring",ear2="Malignance Earring",
		body="Ebers Bliaut +1",hands="Weath. Cuffs +1",ring1="Haoma's Ring",ring2="Menelaus's Ring",
		back={ name="Alaunus's Cape", augments={'MND+20','MND+10','Enmity-10',}},waist="Witful Belt",legs="Ebers Pant. +1",feet="Vanya Clogs"}

	sets.midcast.StatusRemoval = set_combine(sets.midcast.Cure, {ammo="Hasty Pinion +1",head="Ebers Cap +1",feet="Regal Pumps +1",waist="Witful Belt"})  
	...
	sets.midcast['Enhancing Magic'] = {ring1="Stikini Ring +1",ring2="Stikini Ring +1"} --[[{main=gear.gada_enhancing_club,sub="Ammurapi Shield",ammo="Hasty Pinion +1",
		head="Telchine Cap",neck="Incanter's Torque",ear1="Andoaa Earring",ear2="Gifted Earring",
		body="Telchine Chas.",hands="Telchine Gloves",ring1="Stikini Ring +1",ring2="Stikini Ring +1",
		back="Perimede Cape",waist="Embla Sash",legs="Telchine Braconi",feet="Theo. Duckbills +3"}--]]

	sets.midcast.Stoneskin = set_combine(sets.midcast['Enhancing Magic'], {waist="Siegel Sash"})--{neck="Nodens Gorget",ear2="Earthcry Earring",waist="Siegel Sash",legs="Shedir Seraweels"})
	...
	sets.midcast.Protect = set_combine(sets.midcast['Enhancing Magic'], {waist="Sekhmet Corset"})--{ring2="Sheltered Ring",feet="Piety Duckbills +1",ear1="Gifted Earring",waist="Sekhmet Corset"})
	sets.midcast.Protectra = set_combine(sets.midcast['Enhancing Magic'], {waist="Sekhmet Corset"})--{ring2="Sheltered Ring",feet="Piety Duckbills +1",ear1="Gifted Earring",waist="Sekhmet Corset"})
	sets.midcast.Shell = set_combine(sets.midcast['Enhancing Magic'], {waist="Sekhmet Corset"})--{ring2="Sheltered Ring",legs="Piety Pantaln. +1",ear1="Gifted Earring",waist="Sekhmet Corset"})
	sets.midcast.Shellra = set_combine(sets.midcast['Enhancing Magic'], {waist="Sekhmet Corset"})--{ring2="Sheltered Ring",legs="Piety Pantaln. +1",ear1="Gifted Earring",waist="Sekhmet Corset"})
	...
	sets.idle.PDT = {main="Malignance Pole",sub="Mensch Strap +1",ammo="Homiliary",
		...
		body="Ayanmo Corazza +2",hands="Aya. Manopolas +2",ring1="Defending Ring",ring2="Stikini Ring +1",
		back="Moonlight Cape",waist="Carrier's Sash",legs="Aya. Cosciales+1",feet="Aya. Gambieras +1"}
		
	sets.idle.MDT = sets.idle.PDT --[[{main="Daybreak",sub="Ammurapi Shield",ammo="Homiliary",
	...
	sets.idle.Weak = sets.idle.PDT --[[{main="Bolelabunga",sub="Genmei Shield",ammo="Homiliary",
		--head="Befouled Crown",neck="Loricate Torque +1",ear1="Etiolation Earring",ear2="Ethereal Earring",
	...
	sets.defense.MDT = sets.defense.PDT --[[{main="Daybreak",sub="Ammurapi Shield",ammo="Staunch Tathlum +1",
		head="Nyame Helm",neck="Warder's Charm +1",ear1="Etiolation Earring",ear2="Ethereal Earring",
		body="Nyame Mail",hands="Nyame Gauntlets",ring1="Shadow Ring",ring2="Archon Ring",
		back="Moonlight Cape",waist="Carrier's Sash",legs="Nyame Flanchard",feet="Nyame Sollerets"}--]]

    sets.defense.MEVA = sets.defense.PDT --[[{main="Daybreak",sub="Ammurapi Shield",ammo="Staunch Tathlum +1",
		head="Nyame Helm",neck="Warder's Charm +1",ear1="Etiolation Earring",ear2="Ethereal Earring",
