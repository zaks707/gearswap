...
function init_gear_sets()
	...
	sets.midcast['Dread Spikes'] = set_combine(sets.midcast['Dark Magic'], {body="Heathen's Cuirass +1",ear1="Odnowa Earring +1",head="Ratri Sallet +1",hands="Ratri Gadlings +1",feet="Ratri Sollerets"})
    ...
    sets.precast.WS = {ammo="Knobkierrie",
		...
		body="Ignominy Cuirass +2",hands="Sakpata's Gauntlets",ring1="Shukuyu Ring",ring2="Niqmaddu Ring",
    ...
    sets.idle = {ammo="Staunch Tathlum",
		head="Sakpata's Helm",neck="Coatl Gorget +1",ear1="Cessance Earring",ear2="Telos Earring",
		body="Sakpata's Plate",hands="Sakpata's Gauntlets",ring1="Stikini Ring +1",ring2="Stikini Ring +1",
		back="Agema Cape",waist="Flume Belt +1",legs="Carmine Cuisses +1",feet="Sakpata's Leggings"}
		
    sets.idle.PDT = set_combine(sets.idle, {ring1="Defending Ring"})
	...
	sets.engaged = {ammo="Aurgelmir Orb",
		head="Flam. Zucchetto +2",neck="Abyssal Beads +2",ear1="Telos Earring",ear2="Cessance Earring",
		...
		waist="Ioskeha Belt +1",legs="Sakpata's Cuisses",feet="Flam. Gambieras +2"}
